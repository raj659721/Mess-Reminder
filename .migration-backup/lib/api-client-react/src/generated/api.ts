...
export const upsertEntry = async (
  upsertEntryBody: UpsertEntryBody,
  options?: RequestInit,
): Promise<Entry> => {
  return customFetch<Entry>(getUpsertEntryUrl(), {
    ...
    body: JSON.stringify(upsertEntryBody),
  });
};
...
export const getGetTodayEntryQueryKey = () => {
  return [`/api/entries/today`] as const;
};

export const getGetTodayEntryQueryOptions = <
  TData = Awaited<ReturnType<typeof getTodayEntry>>,
  TError = ErrorType<void>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getTodayEntry>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getTodayEntry>>> = ({
    signal,
  }) => getTodayEntry({ signal, ...requestOptions });
...
export type GetTodayEntryQueryResult = NonNullable<
  Awaited<ReturnType<typeof getTodayEntry>>
>;
...
export function useGetTodayEntry<
  TData = Awaited<ReturnType<typeof getTodayEntry>>,
  TError = ErrorType<void>,
>(options?: {
  query?: UseQueryOptions<
